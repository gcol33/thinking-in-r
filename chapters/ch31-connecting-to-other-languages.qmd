...
`.Call()` is R's native foreign function interface. Every other approach (Rcpp, extendr) eventually produces code that R loads the same way. Understanding `.Call()` means understanding the foundation.
