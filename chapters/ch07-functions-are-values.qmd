...
`transforms` is a list of three functions, accessed with `$` like any named list element. A list of functions keyed by name is a *dispatch table*: given a key, it returns the function you need, no conditionals required.

Here is the column-summary problem solved with a dispatch table:
