...
Lambda calculus (@sec-church) is built on applying functions to arguments. Composition\index{function composition} is the next step: apply one function, then apply another to the result.
