...
That structure is the data frame\index{data frame}: a list where every element is a vector of the same length. Lists hold anything; a data frame constrains that freedom to equal-length columns, and once you see this, subsetting, column operations, and the entire tidyverse make sense.
...
A tibble\index{tibble} is the tidyverse's answer to all three problems:
