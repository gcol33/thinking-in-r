...
Today, the Curry-Howard correspondence is the foundation of *formal verification*: software that proves other software is correct. Languages like Coq and Lean let you write a program and a mathematical proof that the program does what you claim, and the compiler checks both. Here is a proof in Lean that adding zero to any natural number gives back the same number:
