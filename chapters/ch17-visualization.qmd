...
This chapter assumes you have tidy data (@sec-tidy-data), can reshape it with dplyr (@sec-data-transformation), and can pipe it through transformations (@sec-pipes-and-composition). Visualization is the payoff: you have cleaned the data, now you see it.
...
Themes are purely cosmetic: the grammar is the substance of this chapter, not the polish, so spend your time on clear mappings and good labels before worrying about fonts.
